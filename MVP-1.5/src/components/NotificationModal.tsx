...
export const NotificationModal: React.FC<NotificationModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleRequestPermission = async () => {
    ...
    if (perm === 'granted') {
      ...
      NotificationService.dispatchNotification({
        title: '🔔 QAWAQ AI // Notificaciones Activas',
        body: 'El sistema SSOMA te alertará inmediatamente ante cualquier riesgo en obra.',
  ...
  const handleImmediateTest = () => {
    NotificationService.dispatchNotification({
      ...
      body: 'Prueba de notificación instantánea en tiempo real. Sistema SSOMA operativo.',
      tag: `test-${Date.now()}`,
      soundType: 'alarm',
    });
