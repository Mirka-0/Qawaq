  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-[#111827] border-2 border-red-500 rounded-3xl shadow-[0_0_50px_rgba(239,68,68,0.4)] overflow-hidden flex flex-col text-[#f3f4f6]">
        {/* Solid Top Alert Bar */}
        <div className="bg-gradient-to-r from-red-600 via-amber-600 to-red-600 px-4 py-2.5 flex items-center justify-between text-white shadow-sm">
          <div className="flex items-center gap-2">
            <Radio className="w-4 h-4 text-white" />
            <span className="font-mono text-xs font-black uppercase tracking-wider">
              🚨 PUSH ALERT // DETECCIÓN CRÍTICA EN TIEMPO REAL
            </span>
          </div>
          <button
        ...
        <div className="p-4 sm:p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-500 hover:to-amber-500 text-white font-['Chivo'] font-black text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-red-600/30 transition-all active:scale-95"
            >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 py-3 px-3 rounded-xl bg-[#1e293b] hover:bg-[#283548] text-[#94a3b8] hover:text-white font-mono text-xs uppercase font-bold border border-[#334155] flex items-center justify-center gap-1.5 transition-colors"
              >
              ...
              <button
                type="button"
                onClick={dismissPushAlert}
                className="py-3 px-4 rounded-xl bg-transparent hover:bg-white/5 text-[#94a3b8] hover:text-white font-mono text-xs uppercase font-bold border border-transparent transition-colors"
              >
                Descartar
              </button>
            </div>
