              ...
              return (
                ...
                >
                  ...
                  <div className="flex gap-3 pl-2 items-center">
                    <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-xl overflow-hidden shrink-0 bg-[#060e20] relative border border-[#222a3d]">
                      <img
                      ...
                      <span className="absolute bottom-0.5 right-0.5 bg-[#060e20]/90 text-[#dae2fd] font-mono text-[8px] px-1 rounded uppercase">
                        {item.detectadoPor === 'Cámara IA' ? 'CAM-IA' : 'MANUAL'}
                      </span>
                    </div>
