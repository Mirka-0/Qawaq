    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-3xl bg-[#0c1322] border border-[#222a3d] rounded-2xl shadow-2xl overflow-y-auto max-h-[94vh]">
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          {/* Description */}
          <div>
            <h4 className="text-xs font-mono uppercase text-[#64748b] font-bold mb-1.5">
              Descripción de la Condición Insegura
            </h4>
            <p className="text-xs sm:text-sm text-[#dae2fd] leading-relaxed bg-[#070d18] p-3.5 rounded-xl border border-[#1e293b]">
